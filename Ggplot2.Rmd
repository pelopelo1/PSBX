---
title: "Courte introduction à Ggplot2"
...
Même les utilisateurs les plus expérimentés de R ont besoin d'aide pour créer des graphiques élégants. Cette bibliothèque est un outil phénoménal pour la création de graphiques dans R mais même après de nombreuses années d'utilisation quasi quotidienne, nous devons toujours nous référer à notre "Cheat Sheet".
...
#Le résulta sera donné en dessous
plot(pressure)
```
